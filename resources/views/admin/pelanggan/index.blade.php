<x-layout>
    ...
    <main>
        <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
            <!-- Breadcrumb Start -->
            <div x-data="{ pageName: `Data Pelanggan` }">
                            ...
                            <form action="{{ route('admin.pelanggan') }}" method="get">
                                <div class="flex justify-between mb-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" placeholder="cari pelanggan..." id="search-input"
                                            name="pelanggan" value="{{ request('pelanggan') }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-5 py-4 sm:px-6">
                                                            <div class="flex items-center">
                                                                ...
                                                                {{-- <form
                                                                    action="{{ route('admin.pelanggan.delete', ['id' => $pelanggan['kode_pelanggan']]) }}"
                                                                ...
                                                                <a href="{{ route('admin.pelanggan.show', ['id' => $pelanggan['kode_pelanggan']]) }}"
