<nav x-data="{ selected: $persist('{{ $selected }}') }">
    ...
    <div>
        ...
        <ul class="flex flex-col gap-4 mb-6">
            <x-side-link href="{{ route('finance.dashboard') }}" label="Dashboard" selected={{ $selected }}
            ...
            <x-side-link href="{{ route('finance.kategori') }}" label="Kategori Pengeluaran"
                selected={{ $selected }}
