                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            <a href="{{ route('gudang.retur.create') }}"
                            ...
                            <form action="{{ route('gudang.retur') }}" method="get">
                                            ...
                                            @foreach ($returs as $retur)
                                                <tr>
                                                        ...
                                                        <div class="flex items-center">
                                                            <div class="flex -space-x-2">
                                                                <p
                                                                    class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                                    @php
                                                                        $totalJumlahSatuan = $retur->details->sum(
                                                                            'jumlah_satuan',
                                                                        );
                                                                    @endphp
                                                                    {{ $totalJumlahSatuan }}
                                                                    {{ $retur->details[0]->produk->satuan }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            <form
                                                                action="{{ route('gudang.retur.delete', ['id' => $retur['id_retur']]) }}"
                                                            ...
                                                            <a href="{{ route('gudang.retur.detail', ['id' => $retur['id_retur']]) }}"
                                                            ...
                                                            <a href="{{ route('gudang.retur.show', ['id' => $retur['id_retur']]) }}"
