                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            Kode</label>
                        <input type="text" value="{{ $retur->details[0]->produk->kode }}"
                    ...
                    <div>
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            Name</label>
                        <input type="text" value="{{ $retur->details[0]->produk->name }}"
                            class="dark:bg-dark-900 shadow-theme-xs  focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border  bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden  dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 "
                            readonly disabled />
                    </div>
                    <div>
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            Kategori</label>
                        <input type="text" value="{{ $retur->details[0]->produk->kategori->name }}"
                            class="dark:bg-dark-900 shadow-theme-xs  focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border  bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden  dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 "
                            readonly disabled />
                    </div>
                    <div>
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            Merk</label>
                        <input type="text" value="{{ $retur->details[0]->produk->merk }}"
                            class="dark:bg-dark-900 shadow-theme-xs  focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border  bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden  dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 "
                            readonly disabled />
                    </div>
                    <div>
                        ...
                        <div id="previewFoto" class="mt-4">
                            ...
                            @if (!empty($retur->details[0]->produk->foto))
                                <img src="{{ asset('storage/produk/' . $retur->details[0]->produk->foto) }}"
                                    alt="Foto Saat Ini" class="max-w-[200px] mt-2 rounded shadow">
                            @else
                                <img src="{{ asset('storage/produk/' . $retur->details[0]->produk->foto) }}"
                                    alt="Foto Saat Ini" class="max-w-[200px] mt-2 rounded shadow">
                            @endif
                    ...
                    <div>
                        ...
                        <textarea placeholder="........" type="text" rows="6"
                            ...
                            readonly disabled>{{ $retur->details[0]->produk->keterangan }}</textarea>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="px-5 py-4 sm:px-6">
                                        <div class="flex items-center">
                                            <div class="flex -space-x-2">
                                                <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                    {{ $detail->jumlah_satuan }} {{ $detail->satuan }}
                                                    {{ $detail->pcs != 0 ? $detail->pcs . ' pcs' : '' }}
                                                </p>
                                            </div>
                                        </div>
                                    </td>
