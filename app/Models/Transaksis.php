...
class Transaksis extends Model
{
    ...
    // Relationship: A transaction has many Surat Jalan details (sj_detail)
    public function sjDetails(): HasMany
    {
        return $this->hasMany(SjDetail::class, 'kode_faktur', 'kode_faktur');
    }
}
